...
def upgrade():
    ...
    op.drop_column('clue_options', 'is_bonus')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('clue_options', sa.Column('is_bonus', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False, nullable=True))
    op.drop_column('clue', 'is_bonus')
